...
class LDAPAuthenticator:
    ...
    def resolve_username(self, username_supplied_by_user):
        ...
        conn = await asyncio.get_running_loop().run_in_executor(
            self.get_connection, search_dn, self.lookup_dn_search_password
        )
    ...
    async def authenticate(self, username: str, password: str):
        ...
        for dn in bind_dn_template:
            ...
            try:
                conn = await asyncio.get_running_loop().run_in_executor(
                    self.get_connection, userdn, password
                )
                ...
                if conn.bound:
                    ...
                    await asyncio.get_running_loop().run_in_executor(conn.bind)
